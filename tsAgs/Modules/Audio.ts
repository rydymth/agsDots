...
const audioStreams = (type: string = "speaker") =>
  Widget.Box({
    vertical: true,
    ...
    children: [
      ...
      Widget.Box({
        ...
        vertical: true,
        children: audio.bind("speakers").as((stream) =>
          stream.map((str) =>
            Widget.EventBox({
              ...
              child: Widget.Box({
                ...
                children: [
                  Widget.Icon({
                    ...
                    icon:
                      type === "speaker"
                        ? audioIcons.volume.medium
                        : audioIcons.mic.medium,
                  }),
                  Widget.Label({
                    hpack: "center",
              ...
              on_primary_click: () => {
                ...
                if (type === "speaker") audio.speaker = str;
                else audio.microphone = str;
              },
            }),
          ),
        ),
...
const audioIcon = (type: string = "speaker") =>
  Widget.Icon({
    ...
    setup: (self) =>
      self.hook(audio, () => {
        ...
        const { muted, low, medium, high } =
          type === "speaker" ? audioIcons.volume : audioIcons.mic;
        const cons = [
          [67, high],
          [34, medium],
          [1, low],
        ...
        else vol = audio.microphone.is_muted ? 0 : audio.microphone.volume;
...
export const audioWin = (type: string = "speaker") =>
  Widget.Window({
    name: `${type}Window`,
